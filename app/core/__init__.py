...
# quality_metrics.py      — deterministic candidate quality metrics (format, diversity, overlap, red flags)
# quality_assessment.py   — optional Ollama-powered qualitative judgment of candidates
